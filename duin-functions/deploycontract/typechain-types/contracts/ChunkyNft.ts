...
export interface ChunkyNftInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "transferNFTToUser",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ChunkyNft extends BaseContract {
  ...
  mintAndTransfer: TypedContractMethod<
  ...
  transferNFTToUser: TypedContractMethod<
    [to: AddressLike, tokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "mintAndTransfer"
  ): TypedContractMethod<
    [to: AddressLike, tokenURI: string],
    [bigint],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "transferNFTToUser"
  ): TypedContractMethod<
    [to: AddressLike, tokenId: BigNumberish],
    [void],
    "nonpayable"
